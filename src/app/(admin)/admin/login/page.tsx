  ...
  return (
    <div className="flex min-h-dvh items-center justify-center bg-ground px-4">
      <div className="w-full max-w-sm">
        <div className="mb-6">
          <p className="text-lead font-bold tracking-[-0.03em]" style={{ fontStretch: '88%' }}>
            ANAID
          </p>
          <p className="text-small text-ink-muted">Staff dashboard</p>
        </div>

        <form action={action} className="space-y-4 rounded-lg border border-hairline bg-surface shadow-xs p-5">
          {state.message && (
